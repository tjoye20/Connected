...
user1 = User.create(username: 'holly123', email: "holly@gmail.com", password: "abc123",password_confirmation: "abc123", image_url: Faker::Avatar.image, bio: bios.sample, city: "Austin", state: "Texas", zipcode: 78756)
user2 = User.create(username: 'rachel345', email: "iliketoshop@gmail.com", password: "abc123",password_confirmation: "abc123", image_url: Faker::Avatar.image, bio: bios.sample, city: "Austin", state: "Texas", zipcode: 78756)
user3 = User.create(username: 'Ross', email: "ross123@hotmail.com", password: "abc123",password_confirmation: "abc123", image_url: Faker::Avatar.image, bio: bios.sample, city: "Austin", state: "Texas", zipcode: 78756)
User.create(username: 'Charlie', email: "charlie@gmail.com", password: "abc123",password_confirmation: "abc123", image_url: Faker::Avatar.image, bio: bios.sample, city: "Austin", state: "Texas", zipcode: 78756)
User.create(username: 'Lucy', email: "bluedresses4va@gmail.com", password: "abc123",password_confirmation: "abc123", image_url: Faker::Avatar.image, bio: bios.sample, city: "Austin", state: "Texas", zipcode: 78756)
